...
class App {
  constructor(routes, webPort, webpackDevServerPort, indexBundle, gifClient, votingClient) {
    this.webPort = webPort;
    this.webpackDevServerPort = webpackDevServerPort;
  ...
  async _ListAll() {
    let response = await wrapOp(this.gifClient.CollectAll.bind(this.gifClient))();
  ...
  async handleJs(req, res) {
    const indexBundle = path.join(__dirname, '/dist/index_bundle.js');
...
module.exports.create = async(webPort, webpackDevServerPort, indexBundle, gifClient, votingClient) => {
  let app = express();
  ...
  new App(routes, webPort, webpackDevServerPort, indexBundle, gifClient, votingClient);
